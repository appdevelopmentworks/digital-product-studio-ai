...
type: A1                                    # コーポレートサイト
status: active                              # Phase H 完走後も継続運用(自社サイト)
phase: post-launch                          # discovery → strategy → design → implementation → qa → launch → post-launch (Phase H 完走 2026-07-15)
...
launched_at: 2026-06-15                     # Phase H で公開
completed_at: null                          # 自社案件のため継続運用 — Phase H 検証完了は 2026-07-15
